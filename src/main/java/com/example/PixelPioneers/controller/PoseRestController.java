...
public class PoseRestController {
    ...
    @GetMapping("/poses")
    public ResponseEntity<?> adminPoseListByPeopleCount(@RequestParam(value = "category") String category, @RequestParam(value = "peopleCount", defaultValue = "0") int peopleCount) {
